...
public static class 黑色尖条流动粒子系统菜单
{
    [MenuItem("GameObject/特效/黑色尖条流动粒子系统", false, 12)]
    private static void CreateBlackStripFlowParticleSystem(MenuCommand menuCommand)
    {
        GameObject particleObject = new GameObject("黑色尖条流动粒子系统");
        ...
        Undo.RegisterCreatedObjectUndo(particleObject, "创建黑色尖条流动粒子系统");

        particleObject.AddComponent<ParticleSystem>();
        particleObject.AddComponent<黑色尖条流动粒子系统>();
